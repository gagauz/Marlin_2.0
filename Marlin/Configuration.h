...
#define CUSTOM_MACHINE_NAME "xl0e Delta"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 182.985            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 127.000            // (mm) Get this value from G33 auto calibrate
 ...
 */
#define DEFAULT_XYZ_STEPS_PER_UNIT 400
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 21.780 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -5.99   // Z offset: -below +above  [the nozzle]
